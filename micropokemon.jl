"""
micropokemon: microgpt trained on Pokemon names to generate new Pokemon-like names.
...
function run(num_steps)
    ...
    # Inference: may the model generate new Pokemon names
    temperature = 0.5
    println("\n--- inference (new, hallucinated pokemon names) ---")
